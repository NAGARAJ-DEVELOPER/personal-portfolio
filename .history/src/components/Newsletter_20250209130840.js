            ...
            <Col xs={8} md={6} xl={7}>
              <form onSubmit={handleSubmit}>
                ...
                <Col xs={8}>
                  ...
                  <Col xs={8}>
                  <button type="button" > <a onClick={handleClick} href={`mailto:nagarajkolle18@gmail.com?subject=Connect%20with%20you&body=${encodeURIComponent("Dear Nagaraju Kolle,\n\n"+email+"\n\nThanks and Regards,\n\n")}`} target="_blaink" style={{ textDecoration: 'none',color:"black"}} > Submit</a></button>
                  </Col>
                </div>
              </form>
            </Col>
